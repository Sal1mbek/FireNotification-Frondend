        ...
        <div class="flex gap-4 p-2 border rounded-lg">
            ...
            <div class="flex flex-col p-2 justify-center">
                ...
                <p class="text-gray-600 text-md">
                    Welcome to the FireAlert System! Our mission is to provide a reliable and efficient platform for
                    reporting and managing fire incidents. We aim to enhance community safety by enabling users to
                    report fires quickly and receive timely alerts.
                </p>
            </div>
        </div>
        <div class="flex gap-4 p-2 border rounded-lg">
